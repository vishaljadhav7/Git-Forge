...
Ask questions about codebases in plain English
...
Create a Project: Enter a GitHub repository URL
Repository Analysis: Wait for AI to process and index the codebase
Query the Code: Ask questions about the repository in natural language
Get Insights: Receive relevant code snippets with AI explanations
Explore Commits: Review recent changes and project evolution

Built with ❤️ by Vishal Jadhav
